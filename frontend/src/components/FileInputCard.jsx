  ...
  return (
    <Card title="Upload File">
      {file ? (
        ...
        <label
          htmlFor="file-input"
          className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:bg-gray-100 transition"
        >
